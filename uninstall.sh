...
UNINSTALL_DECISIONS[bat]=0 UNINSTALL_DECISIONS[zoxide]=0 UNINSTALL_DECISIONS[ghq]=0 UNINSTALL_DECISIONS[wtp]=0
...
IS_INSTALLED[bat]=0 IS_INSTALLED[zoxide]=0 IS_INSTALLED[ghq]=0 IS_INSTALLED[wtp]=0
...
show_summary() {
    ...
    for pkg in neovim tmux zellij ghostty font amu gh glow fzf fd bat zoxide ghq wtp starship bash_completion claude_code; do
